    ...
    <div className={styles.tech}>
      ...
      <div className="hero" data-aos="fade-up">
        <div className="heroText">
          ...
          <p>
            ...
            and deliver IT and digital solutions both hard ware and software
            that help businesses in Nigeria and beyond run smoother, faster, and
            smarter.
          </p>
      ...
      <section className={styles.about} data-aos="fade-up">
        <div className={styles.aboutText}>
          ...
          <p className={styles.aboutparagraph}>
            At FSX Tech, We are a leading provider of smart digital and IT
            solutions in Nigeria, dedicated to helping businesses transform
            their operations through innovative technology.
          </p>
          <p>
            Our mission is to deliver IT and digital solutions that help
            businesses run smoother, faster, and smarter. From laptops and CCTV
            systems to network infrastructure and digital transformation
            consulting, we provide comprehensive technology solutions tailored
      ...
      <section className={styles.services} id="services" data-aos="fade-up">
        <div className="sectionHead">
          <h2>Our Services</h2>
          <h6>
            We provide comprehensive IT solutions and smart technolofies
            designed to simplify operations and drive business growth across
            Nigeria and beyond.{" "}
          </h6>
        </div>
        ...
        <div className="grid">
          {[
            {
              img: "/Core value section Icon (2).png",
              title: "Security Solution",
              desc: "CCTV systems, access control, and monitoring to protect your assets.",
            },
            {
              img: "/monitor (1).png",
              title: "IT Equipment Supply",
              desc: "Laptops, printers, smart office automation, and conference cameras.",
            },
            {
              img: "/Network (2).png",
              title: "Network Infrastructure",
              desc: "Routers, switches, and wireless solutions for reliable connectivity.",
            },
            {
              img: "/Settings (1).png",
              title: "IT Consulting",
              desc: "Technology planning and digital transformation strategies.",
            },
            {
              img: "/certification-icon.svg",
              title: "Technical Support",
              desc: "24/7 support and maintenance to keep systems running smoothly.",
            },
            {
              img: "/innovation-hub-icon.svg",
              title: "Digital Solutions",
              desc: "Custom software and digital tools to enhance productivity.",
            },
          ].map((s, i) => (
      ...
      <section className={styles.products} data-aos="fade-up">
        <div className="sectionHead">
          ...
          <h6>
            Premium IT equipment and technology solutions tailored for Nigerian
            businesses.
          </h6>
        </div>
        ...
        <div className={styles.productsFooter}>
          <p>
            <em>Need custom configurations or bulk orders?</em>
          </p>
          <a href="#" className={styles.accentButton} onClick={scrollToContact}>
